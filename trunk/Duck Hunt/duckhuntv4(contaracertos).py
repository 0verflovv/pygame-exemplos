#-------------------------------------------------------------------------------
# Name:        Duck Hunt v4
# Purpose:     Conta o numero de acerto de patos como pontos
#
# Author:      Johann
#
# Created:     13/02/2011
...
while True:
    ...
    if x_clique + 50 in range(x_duck - 30, x_duck + 30) and y_clique + 50 in range(y_duck - 30, y_duck + 30):
        # vao ser acumulados varios pontos pois mesmo apos o clique, esse clique continua nos range
        # ainda por um certo tempo, por isso vai-se entrar nesse if um certo numero de vezes a cada clique no pato
        pontos += 1
