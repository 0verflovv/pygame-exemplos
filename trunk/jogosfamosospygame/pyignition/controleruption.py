...
text = font.render("tech demo", True, (255, 255, 255), (0, 0, 0))
text2 = font2.render("PyGame", True, (200, 200, 200), (0, 0, 0))
textalpha = font.render("tech demo", True, (255, 255, 255))
text2alpha = font2.render("PyGame", True, (200, 200, 200))
temptext = text.copy()
